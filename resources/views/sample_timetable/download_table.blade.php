...
<div class="{{ trans('messages.widget_theme') . '  center' }}">
    <div class=" {{ trans('messages.alert_theme') . ' card-content center'}}">
        @lang('messages.university')<br>  @lang('messages.academic_year'): {{ $year->year_value }} <br> {{ Auth::user()->user_name . '\'s ' }} Compulsary Timetable
    </div>
</div>
<div class="center">
    <h5 style="text-transform: capitalize;color: grey;">@lang('messages.t_caption')</h5>
</div> <br>
<table class="striped responsive-table centered materialbox-boxed card-content">
    <thead>
    <tr>
