        ...
        <div class="container">
                        ...
                        <select data-live-search="true" id="year" name="year" class="@lang('messages.select_text_color') selectpicker" required>
                            ...
                            @foreach($allYears as $academic_year)
                                <option value="{{ $academic_year->year_value}}"
                                        data-icon="{{ asset('avatars/department.jpeg') }}"
            ...
            <div id="faculty">
                ...
                <div class="alert alert-success alert-dismissible" role="alert" style="border-radius: 30px">
                    ...
                    {{$faculty->faculty_name. '\'s '}}@lang('messages.generate_faculty')
                </div>
                <br><br>

                <div class="row" id="faculty_info">
                ...
                <div class="card-content">
                    <button type="" class="btn btn-float bgm-white m-btn ">
                        <a class="{{ trans('messages.theme')}}" href="{{ action('General_TimeTable\FacultyTimeTableController@downloadPDF',["year" => $year->year_id,"semester" => $semester->semester_id,"departmentID" => $department->department_id]) }}">
